...
public class CallRecorderBroadcast extends BroadcastReceiver  {
    ...
    public void onReceive(Context context, Intent intent) {
        ...
        try {
            ...
            //call custom screen
                    /*
                      try {
                          al=new AlertDialog.Builder(context.getApplicationContext(), androidx.appcompat.R.style.Theme_AppCompat);
                          LayoutInflater layoutInflater=LayoutInflater.from(context.getApplicationContext());
                          View view=layoutInflater.inflate(R.layout.outcoingcalltheme,null);
                          al.setTitle("Fsfdf");
                          al.setView(view);
                          dialog=al.create();
